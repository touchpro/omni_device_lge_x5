 ...
 * {@hide}
 */
public class LgeX5RIL extends RIL implements CommandsInterface {
    ...
    public LgeX5RIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public LgeX5RIL(Context context, int networkMode, int cdmaSubscription) {
